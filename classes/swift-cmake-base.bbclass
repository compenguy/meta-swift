...
SWIFT_FLAGS = "-target ${SWIFT_TARGET_NAME} -use-ld=lld \
    ...
    -I${STAGING_DIR_NATIVE}/${nonarch_libdir}/${TARGET_SYS}/gcc/${TARGET_SYS}/${SWIFT_GCC_VERSION}/include \
    -I${STAGING_DIR_NATIVE}/${nonarch_libdir}/${TARGET_SYS}/gcc/${TARGET_SYS}/${SWIFT_GCC_VERSION}/include-fixed \
    -I${STAGING_DIR_NATIVE}/${nonarch_libdir}/clang/${SWIFT_CLANG_VERSION}/include \
    -I${STAGING_DIR_NATIVE}/${nonarch_libdir}/clang/${SWIFT_CLANG_VERSION}/include-fixed \
    -Xcc -I${STAGING_DIR_NATIVE}/${nonarch_libdir}/${TARGET_SYS}/gcc/${TARGET_SYS}/${SWIFT_GCC_VERSION}/include \
    -Xcc -I${STAGING_DIR_NATIVE}/${nonarch_libdir}/${TARGET_SYS}/gcc/${TARGET_SYS}/${SWIFT_GCC_VERSION}/include-fixed \
    -Xcc -I${STAGING_DIR_NATIVE}/${nonarch_libdir}/clang/${SWIFT_CLANG_VERSION}/include \
    -Xcc -I${STAGING_DIR_NATIVE}/${nonarch_libdir}/clang/${SWIFT_CLANG_VERSION}/include-fixed \
...
HOST_LLVM_PATH = "${STAGING_DIR_NATIVE}/${nonarch_libdir}"
